const CACHE='cornerstone-v6';
const ASSETS=['./','./index.html','./style.css','./brand.css','./integrations.css','./vault.css','./collaboration.css','./install.css','./auth.css','./settings.css','./app.js','./supabase-auth.js','./mcbride-banner.png','./icon.svg','./manifest.webmanifest'];
