const CACHE='cornerstone-v2';
const ASSETS=['./','./index.html','./style.css','./brand.css','./integrations.css','./vault.css','./collaboration.css','./install.css','./auth.css','./app.js','./mcbride-banner.png','./icon.svg','./manifest.webmanifest'];
